...
Usage() {
    ...
    (C) C.Vriend - 9/12/2021
    code written for ENIGMA OCD for subsegmentation of the hippocampus and amygdala using FreeSurfer 7.1.1
...
echo "continue to hippocampal / amygdala subsegmentation"
		...
		/neurodocker/combine_subnuclei.sh ${outputdir} ${subj}) | tee ${outputdir}/${subj}_hippamygseg.log &
